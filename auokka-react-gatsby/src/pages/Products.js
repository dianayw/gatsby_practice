    ...
    <div className={styles.products}>
      <section className={styles.auokka_brief}>
        ...
        <div className={styles.auokka_text_bg}>
          <img src={projEg1} alt="project example" />
        </div>
      </section>
      <section className={styles.auokka_feature}>
        ...
        <div className={styles.auo_fea_content}>
          ...
          <div className={styles.auo_fea_2}>
            ...
            <p>
              We implement business automation from enrolment to certificate via
              minimize admin involvement on enrollment, payment, training,
          ...
          <div className={styles.auo_fea_3}>
            ...
            <p>
              We provide tailored data analytics on all school data which cover
              trainer workload and performance, trainee attendance, reaction and
              performance during training, partner organisation / companies
          ...
          <div className={styles.auo_fea_4}>
            ...
            <p>
              Our Australian local support team brings instantly hands-on assist
              to avoid business disruption caused by technical or operational
              issues.
            </p>
          </div>
        </div>
